...
{{< figure src="/images/2016-07-13-difficult-debugging/99-bugs-in-the-code.jpg" alt="'Grumpy Cat meme: fixed one bug added 28'" >}}
...
{{< figure src="/images/2016-07-13-difficult-debugging/treemap.png" alt="'Example treemap'" >}}
...
{{< figure src="/images/2016-07-13-difficult-debugging/15k_treemap.png" alt="'Treemap with 15,000 cells'" >}}
...
{{< figure src="/images/2016-07-13-difficult-debugging/500_treemap.png" alt="'Treemap with 500 cells'" >}}
...
{{< figure src="/images/2016-07-13-difficult-debugging/sad_panda.png" alt="'Meme: 20 days of debugging makes me a sad panda'" >}}
...
{{< figure src="/images/2016-07-13-difficult-debugging/semi-colon.jpg" alt="'Meme: Semi-colons are the hide and seek champion since 1958'" >}}
